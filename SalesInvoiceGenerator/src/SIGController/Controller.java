    ...
    private void loadFile() throws IOException {
        ...
        if (fileChooser.showOpenDialog(null) == JFileChooser.APPROVE_OPTION) {
            ...
            if (fileChooser.showOpenDialog(null) == JFileChooser.APPROVE_OPTION) {
                ...
                JOptionPane.showMessageDialog(null, "Header File and Items File Selected successfully", " Invoice Items ", JOptionPane.INFORMATION_MESSAGE);
                HeaderTable hTable = new HeaderTable();
                mainFrame.setHeadersArray(headers);
                hTable.setHeaders(mainFrame.getHeadersArray());
                final String[] names = {"Invoice Number", "Invoice Date", "Customer name", "Total"};
              //  MainFrame.invoiceTable.setModel(hTable);
                mainFrame.getInvoiceTable().setModel(hTable);
    ...
    private void addInvoice() {
        ...
        if ("".equals(customerName)) {
          ...
          //  MainFrame.invoiceTable.setModel(hTable);
              mainFrame.getInvoiceTable().setModel(hTable);
            hFrame.dispose();
            JOptionPane.showMessageDialog(null, "Invoice added successfully", "Add Invoice", JOptionPane.INFORMATION_MESSAGE);
        }
    }

    private void cancelInvoice() {
        JOptionPane.showMessageDialog(null, "Invoice Header didn't saved  ", "", JOptionPane.INFORMATION_MESSAGE);
        hFrame.dispose();
    }

    private void cancelLine() {
        JOptionPane.showMessageDialog(null, "Invoice items didn't saved  ", "", JOptionPane.INFORMATION_MESSAGE);
        lFrame.dispose();
    }
